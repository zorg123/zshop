...
public class ConfigGenerator {
	...
	protected boolean keepOrginalName = true;
	...
	public boolean isKeepOrginalName() {
		return keepOrginalName;
	}

	public void setKeepOrginalName(boolean keepOrginalName) {
		this.keepOrginalName = keepOrginalName;
	}
