 ...
 <body>
  <div id="app">
     ...
     <form class="el-form" data-v-4145efda="">
      ...
      <div class="el-form-item is-required" data-v-4145efda="">       
       <div class="el-form-item__content">
        ...
        <img data-v-4145efda="" id="veri" src="<%=baseUri%>/public/vc.jsp" alt="" onclick="javascript:this.src='<%=baseUri%>/public/vc.jsp?time='+Math.random()" class="veri" />
   ...
   <section id="pageBg" class="row">
    <div id="canvas" style="background: -webkit-gradient(linear, 0% 0%, 100% 0%, from(rgb(110, 192, 252)), to(rgb(255, 99, 233)));">
